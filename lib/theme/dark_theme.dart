...
ThemeData dark = ThemeData(
  ...
  primaryColor: const Color(0xFFA6330A),
  ...
  textButtonTheme: TextButtonThemeData(
      style: TextButton.styleFrom(foregroundColor: const Color(0xFFA6330A))),
  colorScheme: const ColorScheme.dark(
          primary: Color(0xFFA6330A),
          tertiary: Color(0xff6165D7),
          tertiaryContainer: Color(0xff171DB6),
          secondary: Color(0xFFA6330A))
